...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item" id="nav-qr" href="<?php echo e(route('qr.register')); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
      ...
      <div class="section-card">
        <div class="section-header">
          ...
          <div class="section-actions">
            ...
            <button class="btn btn-view-dtr" id="btnViewDtr">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 9v7.5m-9-3h.008v.008H12V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg>
              View DTR
            </button>
  ...
  <!-- ========== DTR LOOKUP MODAL ========== -->
  <div class="modal-overlay" id="dtrLookupOverlay">
    <div class="modal" style="max-width:360px;">
      <div class="modal-title">View DTR</div>
      <div class="modal-grid">
        <div class="form-group full">
          <label>ID Number</label>
          <input type="text" id="dtrLookupId" placeholder="e.g. 202400001" inputmode="numeric" maxlength="20">
        </div>
      </div>
      <div class="modal-footer">
        <button class="btn-cancel" id="dtrLookupCancel">Cancel</button>
        <button class="btn-save" id="dtrLookupOpen">View DTR</button>
      </div>
    </div>
  </div>
...
<?php /**PATH C:\Users\dhary\Documents\attendance-web-based-system\resources\views/dashboard.blade.php ENDPATH**/ ?>